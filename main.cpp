...
int main(int argc, char** argv) {
	...
	if (f_output_file) {
		...
		if (f_list_of_cases) {
			...
			sprintf(solution_file, "%s", fname); // solution_file = output_file
			sprintf(stats_file, "%s", fname); // stats_file = output_file
			_replace(solution_file, '.', "solutions");
			_replace(stats_file, '.', "statistics");
			}
	}
